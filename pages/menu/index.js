...
const MenuDemo = ({ children }) => {
    ...
    const wizardItems = [
        { label: 'Personal', command: () => router.push('/menu') },
        { label: 'Seat', command: () => router.push('/menu/seat') },
        { label: 'Payment', command: () => router.push('/menu/payment') },
        { label: 'Confirmation', command: () => router.push('/menu/confirmation') }
    ];
